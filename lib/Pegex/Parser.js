...
(function() {
  ...
  global.Pegex.Parser = exports.Parser = Parser = (function() {

    function Parser(grammar, receiver) {
      this.grammar = grammar;
      this.receiver = receiver;
      this.receiver || (this.receiver = new Pegex.Receiver);
    ...
    Parser.prototype.parse = function(input, start_rule) {
      ...
      if (typeof grammar === 'string') {
        ...
        this.grammar = new Pegex.Grammar;
      } else {
