...
(function() {
  ...
  global.Pegex.Pegex.AST = exports.AST = AST = (function() {
    ...
    AST.prototype.got_rule_reference = function(match) {
      ...
      if (regex = Pegex.Grammar.Atoms.prototype.atoms()[ref]) {
      ...
      if (prefix) {
        _ref = [this.prefixes[prefix], 1], key = _ref[0], val = _ref[1];
